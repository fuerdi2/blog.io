...
将shp文件导入oracle数据库有多种方式，比如最常用是的oracle公司提供的shp2sdo工具。Shp2sdo工具将shp文件转换成oracle执行脚本，再通过sqlplus以及sqlldr工具将其导入至数据库中。该方法简便直观，但学习过程较有难度，且操作过程也较为繁琐。![shp2sdo命令窗口](https://fuerdi2.github.io/img/shp2oracle/shp2sdo.png) 
